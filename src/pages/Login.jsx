...
const Login = () => {
    ...
    const handleForgetPasword = () => {
        ...
        if (typedEmail) {
            navigate(`/auth/forget-password/${typedEmail}`);
        } else {
            navigate(`/auth/forget-password/none`);
        }
            ...
            <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl py-5">
                ...
                <form onSubmit={handleLogin} className="card-body">
                    <fieldset className="fieldset">
                        ...
                        />
                        <div>
                            <button type='button' onClick={handleForgetPasword} className="link link-hover">Forgot password?</button>
                        </div>
